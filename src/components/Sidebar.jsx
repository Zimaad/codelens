  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#48E5C2" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span
          ...
          style={{
            color: '#48E5C2',
            backgroundColor: 'rgba(72,229,194,0.06)',
          ...
          return (
            <button
              ...
              onClick={() => {
                ...
                searchParams.set('view', item.id);
                navigate(`/explore/${owner}/${repo}?${searchParams.toString()}`);
              }}
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 cursor-pointer"
              style={{
                fontFamily: 'var(--font-display)',
                color: isActive ? '#48E5C2' : 'var(--color-text-secondary)',
                backgroundColor: isActive ? 'rgba(72,229,194,0.05)' : 'transparent',
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #48E5C2, #2dd4bf)',
              color: '#0B1215',
              fontFamily: 'var(--font-display)',
            }}
          >
